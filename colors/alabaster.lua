...
if vim.o.background == "dark" then
    ...
    -- colors
    local default_bg = '#0e1415'
    local bg = vim.g.alabaster_transparent_background and "NONE" or default_bg
    local fg = "#cecece"
    ...
    theme = {
        ...
        --- Notify
        NotifyBackground = { bg = default_bg, fg = fg },
        -- Languages
        --- asm
